...
function getAvailableTimeSlots($conn, $dermatologist_id, $date, $appointment_id)
{
    $available_slots = [
        '10:00' => '10:00 AM',
        '11:00' => '11:00 AM',
    ...
    // Get booked slots for the selected date and dermatologist
    $stmt = $conn->prepare("
        ...
        AND id != ?
    ");
    $stmt->bind_param('isi', $dermatologist_id, $date, $appointment_id);
    $stmt->execute();
    $result = $stmt->get_result();
